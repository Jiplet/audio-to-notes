...
Handles:
- Samsung 3GPP-in-.m4a wrapper (Whisper rejects it; we re-encode first)
- Files over Whisper's 25MB limit (compress to 32 kbps mono MP3)
- Files still over the limit after compression (chunk into 60-min segments)
"""
